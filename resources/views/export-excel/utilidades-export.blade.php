...
<body>
    <table>
        <tbody>
            <tr>
                <td style="text-align: center; font-size: 30px;" colspan="8">Oftalmo<b>Center - Cálculo de
                        Utilidades</b></td>
            </tr>
            <tr></tr>
            <tr>
    ...
    <table cellspacing="0" cellpadding="0">
        <thead>
            <tr>
                ...
                <th style="text-align: center;"><b>Total Comisiones</b></th>
                <th style="text-align: center;"><b>Restante Total</b></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: right;">$ {{ number_format($dComisiones->totalsum_actividades,2) }}</td>
                <td style="text-align: right;">$ {{ number_format($dComisiones->restanteUtilidad,2) }}</td>
