...
class DoctorSeeder extends Seeder
{
    ...
    public function run(){
        $doctoresTab = [    
            ...
            ["doctor_titulo" => "Dr.",  "doctor_nombre" => "Gonzalo",    "doctor_apellidop" => "Padilla",     "doctor_apellidom" => "Aguilar",  "doctor_email" => "gonzalopadilla@me.com",                  "doctor_status" => "A", "categoria_id" => "3"],
            ["doctor_titulo" => "Dra.", "doctor_nombre" => "Alejandra",  "doctor_apellidop" => "Ocampo",      "doctor_apellidom" => "García",   "doctor_email" => "oftalmologaalejandraocampo@gmail.com",   "doctor_status" => "A", "categoria_id" => "2"],
            ["doctor_titulo" => "Dr.",  "doctor_nombre" => "Efren",      "doctor_apellidop" => "Muñoz",       "doctor_apellidom" => "Miranda",  "doctor_email" => "emz.oftalmo@gmail.com",                  "doctor_status" => "A", "categoria_id" => "2"],
            ["doctor_titulo" => "Dr.",  "doctor_nombre" => "Juan Carlos","doctor_apellidop" => "de la Luz",   "doctor_apellidom" => "Osnaya",   "doctor_email" => "jcdllo@yahoo.com.mx",                    "doctor_status" => "A", "categoria_id" => "2"],
        ];
        ...
        foreach($doctoresTab as $dres){
            DB::table('doctors')->insert([
                ...
                'doctor_email' => $dres["doctor_titulo"],
