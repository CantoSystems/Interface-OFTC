...
class estudiosSeeder extends Seeder
{
    ...
    public function run(){
        $estudiosInfo = Collect([
            ...
            ["id_estudio_fk" => "2", "id_ojo_fk" => "3", "dscrpMedicosPro" => "HONORARIOS FAG OCT OD"],
            ["id_estudio_fk" => "2", "id_ojo_fk" => "2", "dscrpMedicosPro" => "HONORARIOS FAG OCT OI"],
            ...
            ["id_estudio_fk" => "18", "id_ojo_fk" => "1", "dscrpMedicosPro" => "TOPOGRAFIA POR OCT ANTERION AO"],
            ["id_estudio_fk" => "18", "id_ojo_fk" => "4", "dscrpMedicosPro" => "TOPOGRAFIA POR OCT ANTERION UN OJO"],
            ["id_estudio_fk" => "17", "id_ojo_fk" => "1", "dscrpMedicosPro" => "HONORARIOS FOTO DE NERVIO OPTICO AO"],
            ["id_estudio_fk" => "17", "id_ojo_fk" => "4", "dscrpMedicosPro" => "HONORARIOS FOTO DE NERVIO OPTICO UO"],
            ["id_estudio_fk" => "17", "id_ojo_fk" => "1", "dscrpMedicosPro" => "HONORARIOS FOTOS CLINICAS AO"],
            ["id_estudio_fk" => "17", "id_ojo_fk" => "4", "dscrpMedicosPro" => "HONORARIOS FOTOS CLINICAS UO"]
        ]);
